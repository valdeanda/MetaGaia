...
3. A user created file that contains the KEGG, COG, PFAM, and/or EC_NUMBER pathways of interest.

## Finding commonalities between phages and their hosts (phage-host_analysis)
