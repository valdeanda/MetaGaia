...
```{bash, eval=FALSE}
python3 bin_abundance.py -r ../../data/bin_abundance/reads_file_renamed.tsv -m ../../data/bin_abundance/mapping_file.tsv -d ../../data/bin_abundance/depth_file_renamed.tsv -s ../../data/bin_abundance/binsize_file.tsv -n 1000000
```
