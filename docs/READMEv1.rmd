...
Example of concatenated depth file (NOTE: If the depth_dir argument was used, the Sample_Depth names may need to be edited by the user to match the Sample names in the reads_file.tsv):
...
Example of sample2site file:

```{bash, eval=FALSE}
Sample    Site
AB_3033   San Francisco
AB_1004   Oakland
AB_5468   Berkeley
```
